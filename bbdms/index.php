...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Food and medications Before your blood donation: Get plenty of sleep the night before you plan to donate. Eat a healthy meal before your donation. Avoid fatty foods, such as a hamburger, fries or ice cream</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Blood is needed to keep us alive. It brings oxygen and nutrients to all the parts of the body so they can keep working. Blood carries carbon dioxide and other waste materials to the lungs, kidneys, and digestive system to be removed from the body. Blood also fights infections, and carries hormones around the body.</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
        ...
        <iframe src="http://localhost/v/4" style="width: 460px;height:315px" frameborder="0"></iframe>
        <div class="row">
                   <?php 
$status=1;
